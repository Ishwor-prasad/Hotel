...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>STAYWISE HOTEL,</p>
				<p>UNIVERSITY OF DHAKA ROAD,<br>DHAKA,<br>BANGLADESH.</p>
				<p>01886422493</p>
			</address>
			<span><img alt="" src="assets/img/staywise.png"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@staywise.com || Web :- www.staywise.com || Phone :- 01886422493 </p>
			</div>
		</aside>
	</body>
</html>
